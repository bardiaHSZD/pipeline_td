...
from utils.function_utils import open_create_pipeline_window, open_import_shots_window, exit_program, show_about
...
def create_menu(root):
    ...
    tools_menu.add_command(label="Import Shots", command=lambda: open_import_shots_window(root))
